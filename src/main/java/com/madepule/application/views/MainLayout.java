package com.madepule.application.views;
...
import com.madepule.application.views.MainLayout;
import com.madepule.application.views.helloworld.HelloWorldView;
import com.madepule.application.views.about.AboutView;
 ...
 */
@PWA(name = "Demo Web App", shortName = "Demo Web App", enableInstallPrompt = false)
@Theme(themeFolder = "demowebapp")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Demo Web App logo"));
        logoLayout.add(new H1("Demo Web App"));
